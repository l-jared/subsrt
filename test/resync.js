...
exports['Resync +3000 ms'] = function(test) {
  ...
  if (fs.existsSync('./test/output')) {
    fs.writeFileSync(
      './test/output/resync-add-3000.json',
      JSON.stringify(resynced, ' ', 2),
    );
  }
  ...
  test.ok(
    resynced.length == captions.length,
    'Expected array of length == ' + captions.length,
  );

  test.ok(
    resynced[0].start !== captions[0].start,
    'Expected start frame value shift!',
  );
  test.ok(
    resynced[0].end !== captions[0].end,
    'Expected end frame value shift!',
  );
...
exports['Resync -250 ms'] = function(test) {
  ...
  if (fs.existsSync('./test/output')) {
    fs.writeFileSync(
      './test/output/resync-sub-250.json',
      JSON.stringify(resynced, ' ', 2),
    );
  }
  ...
  test.ok(
    resynced[3].start !== captions[3].start,
    'Expected start frame value shift!',
  );
  test.ok(
    resynced[3].end !== captions[3].end,
    'Expected end frame value shift!',
  );
...
exports['Resync 25 to 30 FPS'] = function(test) {
  ...
  if (fs.existsSync('./test/output')) {
    fs.writeFileSync(
      './test/output/resync-fps-30.json',
      JSON.stringify(resynced, ' ', 2),
    );
  }
  ...
  test.ok(
    resynced[3].frame.start !== captions[3].frame.start,
    'Expected start frame value shift!',
  );
  test.ok(
    resynced[3].frame.end !== captions[3].frame.end,
    'Expected end frame value shift!',
  );
  test.ok(
    resynced[3].frame.count > captions[3].frame.count,
    'Expected increased frame count number!',
  );
...
exports['Resync with non-linear function'] = function(test) {
  ...
  if (fs.existsSync('./test/output')) {
    fs.writeFileSync(
      './test/output/resync-extend.json',
      JSON.stringify(resynced, ' ', 2),
    );
  }
  ...
  test.ok(
    resynced[3].start == captions[3].start + 0,
    'Expected start frame value shift!',
  );
  test.ok(
    resynced[3].end == captions[3].end + 500,
    'Expected end frame value shift!',
  );
